...
This application is a prototype for a child monitoring GPS tracker using nRF9151.
It integrates Firmware-Over-The-Air (FOTA), GNSS location tracking with configurable intervals, and cloud connectivity via AWS and nRF Cloud.
...
.. code-block:: console
   ...
   west build -b nrf9151dk/nrf9151 nrf/applications/kid_gps_tracker

For CoAP protocol, add the overlay:

.. code-block:: console

   west build -b nrf9151dk/nrf9151 nrf/applications/kid_gps_tracker -- -DOVERLAY_CONFIG=overlay_coap.conf
